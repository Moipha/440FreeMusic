  ...
  <el-footer class="footer">
    ...
    <div class="leftContainer">
      ...
      <div style="margin: 15px 10px 15px 20px">
        <el-avatar shape="square" :size="70" :src="url"></el-avatar>
      </div>
      <div class="musicDataContainer">
        <!--歌曲名-->
        <span class="musicName">名称</span>
        <!--专辑名-->
        <span style="font-size: 10px">专辑</span>
      </div>
    </div>
    <!--中间-->
    ...
    <div class="rightContainer">
      ...
      <div @click="like" style="margin-left: 25%;margin-bottom: 22px;margin-right: 10px">
        <svg t="1679376624033" v-if="!isLike" class="iconRight" viewBox="0 0 1024 1024" version="1.1"
        ...
        <svg t="1679376804796" v-if="isLike" class="iconRight" viewBox="0 0 1024 1024" version="1.1"
             xmlns="http://www.w3.org/2000/svg"
      ...
      <!--弹出侧边栏-->
      <svg t="1679378020715" class="iconRight" style="position: fixed;right: 20px;bottom: 30px" viewBox="0 0 1024 1024"
           version="1.1"
           xmlns="http://www.w3.org/2000/svg"
...
export default {
  ...
  methods: {
    ...
    changeCurrentTime(index) {
      ...
      // parseInt(index) / 100 * this.maxTime
    },
    //改变当前音量：要将音量转成0~1的小数
    changeVolume() {
