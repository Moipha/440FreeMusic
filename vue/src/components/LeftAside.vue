<template>
  <el-aside width="250px" style="height: 100%;overflow-x: hidden;display: flex">
    <el-menu style="min-height: 100%; overflow-x: hidden;background-color: var(--leftbg);border: none" router ref="menu"
             :default-active="defaultActiveUrl" unique-opened :default-openeds="['/']">
      <!--头像和登录键-->
      ...
      <div style="height: calc(100% - 92px);overflow-y: scroll">
        <el-menu-item index="/home" class="leftSection">
          <svg t="1680360816994" class="icon leftSectionInner" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="2784" width="13" height="13">
            <path
        ...
        <el-menu-item index="/likes" class="leftSection">
          <svg t="1680361000732" class="icon leftSectionInner" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="7295" width="13" height="13">
            <path
                ...
                fill="currentColor" p-id="7296"></path>
          </svg>
        ...
        <el-menu-item index="/setting" class="leftSection">
          <svg t="1680361090482" class="icon leftSectionInner" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="10945" width="13" height="13">
            <path
                ...
                fill="currentColor" p-id="10946"></path>
          </svg>
    ...
    <!--对话框-->
    <el-dialog :visible.sync="showDialog" :show-close="false" :modal-append-to-body='false' :append-to-body="false">
      ...
      <el-input style="width: 90%;user-select: auto;font-size: 16px" placeholder="请输入新歌单标题" ref="input"
                v-model="newList.title" @keydown.enter.native="create"/>
...
/*点击登录悬浮*/
.clickToLogin:hover .el-icon-arrow-right,
.clickToLogin:hover {
...
.is-active .leftSectionInner * {
  color: var(--btnText);
}

>>> .musicList .el-submenu__title:hover {
